        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Companies_AddressInformation_AddressId",
                        column: x => x.AddressId,
                        principalTable: "AddressInformation",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Companies_ContactInformation_ContactId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FreelanceWorks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FreelanceWorks_AddressInformation_AddressId",
                        column: x => x.AddressId,
                        principalTable: "AddressInformation",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FreelanceWorks_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FreelanceWorks_ContactInformation_ContactId",
                        column: x => x.ContactId,
                        principalTable: "ContactInformation",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FreelanceWorks_Teams_TeamId",
                        column: x => x.TeamId,
                        principalTable: "Teams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Jobs_AddressInformation_AddressId",
                        column: x => x.AddressId,
                        principalTable: "AddressInformation",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Jobs_ContactInformation_ContactId",
                        column: x => x.ContactId,
                        principalTable: "ContactInformation",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FreelanceWorks_AddressId",
                table: "FreelanceWorks",
                column: "AddressId");

            migrationBuilder.CreateIndex(
                name: "IX_FreelanceWorks_CompanyId",
                table: "FreelanceWorks",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_FreelanceWorks_ContactId",
                table: "FreelanceWorks",
                column: "ContactId");

            migrationBuilder.CreateIndex(
                name: "IX_FreelanceWorks_TeamId",
                table: "FreelanceWorks",
                column: "TeamId");
